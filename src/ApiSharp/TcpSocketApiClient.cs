...
{
    public TcpSocketApiClientOptions ClientOptions { get { return (TcpSocketApiClientOptions)_options; } }
    ...
    protected TcpSocketApiClient(TcpSocketApiClientOptions options) : base(options ?? new())
    {
        // Tcp Client
