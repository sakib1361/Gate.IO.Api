...
{
    public WebSocketApiClientOptions ClientOptions { get { return (WebSocketApiClientOptions)_options; } }
    ...
    protected WebSocketApiClient(WebSocketApiClientOptions options) : base(options ?? new())
    {
    }
